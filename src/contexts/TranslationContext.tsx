...
const translations = {
  en: {
    ...
    // Login Modal
    'login.welcome': 'Welcome to VideoPlus',
    'login.title': 'LOGIN',
    ...
    'login.footer.text': 'New to VideoPlus?',
    ...
    'subscription.management.subtitle': 'Manage your VideoPlus subscription and billing',
  ...
  zh: {
    ...
    'subscription.management.subtitle': '管理您的 VideoPlus 订阅和账单',
  ...
  fr: {
    ...
    // Login Modal
    'login.welcome': 'Bienvenue sur VideoPlus',
    ...
    'login.footer.text': 'Nouveau sur VideoPlus ?',
    ...
    'subscription.management.subtitle': 'Gérez votre abonnement VideoPlus et la facturation',
